...
class CLCF_Enqueue_Scripts
{
    ...
    {
        wp_enqueue_style('clcf', CLCF__PLUGIN_URL  . 'assets/css/app.css', array(), CLCF_VERSION, 'all');
    ...
    {
        wp_enqueue_style('carbon-fields-custom-theme', CLCF__PLUGIN_URL  . 'assets/css/carbon-fields-theme.css', array(), CLCF_VERSION, 'all');
    }
}
